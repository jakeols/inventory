...
<div id="wrapper">
    <div id="sidebar-wrapper">
      ...
      <li><a href="<?php echo base_url()?>index.php/User"><span class="glyphicon glyphicon-home"></span> Dashboard</a></li>
      <li><a href="<?php echo base_url()?>index.php/User/new_item"><span class="glyphicon glyphicon-pencil"></span> New Item</a></li>
